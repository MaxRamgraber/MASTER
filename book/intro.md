...
This book is a proof-of-concept and provides a vertical slice of the **M**athematics **A**nd **S**tatistics **T**extbook for **E**ducation and **R**esearch (MASTER) at TU Delft. It should be considered work in progress. Click on the element below to navigate to one of its content articles.
